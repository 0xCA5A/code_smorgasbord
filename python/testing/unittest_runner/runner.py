...
class MyUnittestRunner(object):
    ...
    def __init__(self):
        ...
        self._suite.addTest(unittest2.makeSuite(unittests.mega_feature_2000.MegaFeature2000TestCase, prefix='mega_test_'))
        self._suite.addTest(unittest2.makeSuite(unittests.mega_feature_4000.MegaFeature4000TestCase, prefix='vendor1_'))
    ...
    def run_test(self):
        ...
        logger.info(self._suite._tests)
        logger.info("nr of test cases: %d", self._suite.countTestCases())
